...
class ApplicationForm(OverwriteOnlyModelFormMixin, BetterModelForm):
        ...
        self._fieldsets = [
            ('Personal Info',
             {'fields': ('university', 'degree', 'graduation_year', 'gender', 'other_gender',
                         ...
                         'under_age', 'specialization', 'other_specialization', 'heard_from', 'other_heard_from', 'hardware_requested'),
    ...
    class Meta:
        ...
        labels = {
            ...
            'hardware_requested': 'What hardware would you like to see in the hardware library?',
