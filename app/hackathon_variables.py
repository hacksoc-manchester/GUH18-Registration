...
HACKATHON_NAME = 'StudentHack VII'
# What's the name for the application
HACKATHON_APPLICATION_NAME = 'StudentHack VII registration'
# Hackathon timezone
TIME_ZONE = 'UTC'
# This description will be used on the html and sharing meta tags
HACKATHON_DESCRIPTION = '24 hours hacking, 250 attendees and more than 50 hacks.' \
                        'StudentHack VII aims at being a full experience and ' \
...
HACKATHON_CONTACT_EMAIL = 'studenthack@hacksoc.com'
# Hackathon logo url, will be used on all emails
HACKATHON_LOGO_URL = 'https://i.imgur.com/AINL7nY.png'
...
HACKATHON_TWITTER_ACCOUNT = 'StudentHack'
...
HACKATHON_APP_DEADLINE = timezone.datetime(2019, 3, 31, 23, 59, tzinfo=timezone.pytz.timezone(TIME_ZONE))
